...
(function () {
  ...
  var DICT = {
    ...
    'index.tag3d':      { zh: '3D',               en: '3D' },
    'index.planeName':  { zh: '3D 打飞机 Pro',     en: '3D Plane Battle Pro' },
    'index.planeDesc':  { zh: 'Three.js 制作的 3D 飞行射击：躲避弹幕、击落敌机、挑战 BOSS，还能拾取散弹和护盾道具。键盘鼠标即点即玩。', en: 'A Three.js 3D flight shooter: dodge bullets, shoot down enemies, and battle the BOSS — grab spread-shot and shield pickups along the way. Keyboard & mouse, click and play.' },
    'index.planeDetail':{ zh: '✈️ 3D 立体飞行 &nbsp;|&nbsp; 🔫 子弹+散弹 &nbsp;|&nbsp; 🛡️ 护盾道具 &nbsp;|&nbsp; 👹 BOSS 战 &nbsp;|&nbsp; ⚡ Shift 加力 &nbsp;|&nbsp; ⌨️ 键盘鼠标', en: '✈️ Real 3D flight &nbsp;|&nbsp; 🔫 Guns + spread shot &nbsp;|&nbsp; 🛡️ Shield pickup &nbsp;|&nbsp; 👹 Boss battles &nbsp;|&nbsp; ⚡ Shift boost &nbsp;|&nbsp; ⌨️ Keyboard &amp; mouse' },
    'index.tagShoot':   { zh: '射击',           en: 'Shooter' },
    'index.tagFps':     { zh: 'FPS',            en: 'FPS' },
    'index.tagTactical':{ zh: '战术',           en: 'Tactical' },
    'index.deltaName':  { zh: '三角洲突击 · 网页版FPS', en: 'Delta Assault — Web FPS' },
    'index.deltaDesc':  { zh: '网页版战术第一人称射击！自研3D引擎，守卫基地击退敌军波次。鼠标键盘或手机触控都能玩，无需下载。', en: 'A tactical web FPS on a self-built 3D engine! Defend your base against enemy waves. Play with mouse & keyboard or touch — no download.' },
    'index.deltaDetail':{ zh: '🗺️ 3D战术射击 &nbsp;|&nbsp; 🤖 AI敌方士兵 &nbsp;|&nbsp; 🔫 步枪+换弹 &nbsp;|&nbsp; 🌊 波次防守 &nbsp;|&nbsp; 🖥📱 键鼠触屏都能玩 &nbsp;|&nbsp; 📍 实时小地图', en: '🗺️ 3D tactical shooter &nbsp;|&nbsp; 🤖 AI soldiers &nbsp;|&nbsp; 🔫 Rifle + reload &nbsp;|&nbsp; 🌊 Wave defense &nbsp;|&nbsp; 🖥📱 Desktop &amp; mobile &nbsp;|&nbsp; 📍 Live minimap' },
