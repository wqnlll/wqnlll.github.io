...
(function () {
  ...
  var DICT = {
    ...
    'brick.startSub':   { zh: '打碎砖块学英语单词！适合小学生<br>每个砖块都有 <span class="highlight">英文 + 中文翻译</span><br>打碎时自动朗读发音！', en: 'Break bricks to learn English words! Made for kids<br>Every brick shows <span class="highlight">English + Chinese</span><br>Speaks the word aloud when broken!' },
    ...
    'brick.feature3':   { zh: '<strong>真人发音</strong>：打碎砖块时自动朗读英语发音，帮助建立正确的语音印象', en: '<strong>Real pronunciation</strong>: speaks the English word aloud when you break a brick, building correct sound memory' },
